...
/**
 * Class use by XPath parser to parse specific field in the XML file.
...
public class GenericHandler extends AbstractHandler {
	...
	public GenericHandler(LearningData pLearningData) {
		this.learningData = pLearningData;
	}


	@Override
	public void process() {
		parse(learningData, url, getMurl());
	}
