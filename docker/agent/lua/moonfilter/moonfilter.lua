...
-- Copyright (C) 2007-2011 Christian Siefkes.
--
...
-- v1.02 - 2011-10-01 - Christian Siefkes - Made "text" variable public to
--     allow setting the text to classify/train directly from a script;
--     fixed bug that occurred when train() was invoked without filename and
--     without preceding call to classify()
...
classdir = ""
-- The text to classify/train as a string -- can be set explictly if desired.
text = nil
...
function train(class, filename)
    ...
    if last_classify_result and (filename == last_filename or filename == "")
    then
